        ...
        def target():
            if fileout != None:
                with open(fileout, 'w') as f:
                    #print self.cmd
                    #print "run_single.py: can you see this?" 
...
if __name__ == "__main__":
    ...
    mode = sys.argv.pop(0)
    #print "run_single.py: HERE WE GO!"
    #print sys.argv
    ...
    if mode == "race":
        ...
        for i in range(min,max):
            ...
            run(test, sys.argv, timelimit, outfile)
