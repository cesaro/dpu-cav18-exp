...
void *producer (void *arg)
{
   ...
   ((id < 2) ? (void) (0) : __assert_fail ("id < 2", "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/multiprodcon.c", 63, __PRETTY_FUNCTION__));
   ...
   ((tmp <= pow (2, 2*2)) ? (void) (0) : __assert_fail ("tmp <= pow (2, 2*2)", "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/multiprodcon.c", 80, __PRETTY_FUNCTION__));
