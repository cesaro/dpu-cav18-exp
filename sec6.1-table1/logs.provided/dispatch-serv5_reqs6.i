# 1 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/dispatcher.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/dispatcher.c" 2
...
# 3 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/dispatcher.c" 2
...
# 4 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/dispatcher.c" 2
# 50 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/dispatcher.c"
pthread_mutex_t servers[5];
pthread_mutex_t k;
int sid = 0;
int in_channel[5];
int out_channel[5];
...
int process_request(int req_id, int last_server_id)
{
 ...
 pthread_create(&s, ((void *)0), pick_server, (void*) (long) last_server_id);
...
{
  pthread_t idw[5];
  int picked_servers[6];




  pthread_mutex_init(&k, ((void *)0));
  for (int x = 0; x < 5; x++)
  {
    in_channel[x] = 0;
    out_channel[x] = 0;
    pthread_mutex_init(&servers[x], ((void *)0));
  ...
  for (int r = 0; r < 6; r++){
    if (r == 0)
      picked_servers[r] = process_request(r, 5);
    else
      picked_servers[r] = process_request(r,picked_servers[r-1]);
  }

  pthread_exit (0);
# 205 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/dispatcher.c"
}
