...
void *producer (void *arg)
{
   ...
   ((id < 3) ? (void) (0) : __assert_fail ("id < 3", "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/multiprodcon.c", 63, __PRETTY_FUNCTION__));
   ...
   ((tmp <= pow (3, 2*3)) ? (void) (0) : __assert_fail ("tmp <= pow (3, 2*3)", "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/multiprodcon.c", 80, __PRETTY_FUNCTION__));
