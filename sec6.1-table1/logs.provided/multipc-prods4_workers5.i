...
void *producer (void *arg)
{
   ...
   ((id < 4) ? (void) (0) : __assert_fail ("id < 4", "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/multiprodcon.c", 63, __PRETTY_FUNCTION__));
   ...
   ((tmp <= pow (4, 2*4)) ? (void) (0) : __assert_fail ("tmp <= pow (4, 2*4)", "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/multiprodcon.c", 80, __PRETTY_FUNCTION__));
