# 1 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/mpat.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/mpat.c" 2
...
# 3 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/mpat.c" 2
# 31 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/mpat.c"
...
# 61 "/home/ubuntu/cesar/dpu-cav18-exp/benchmarks/mpat.c"
void *ra(void *arg)
{
 unsigned id = (unsigned long) arg;
...
int main()
{
 ...
 for (int i = 0; i < 8; i++)
 {
   pthread_mutex_init(&ma[i], ((void *)0));
   pthread_create(&idw[i], ((void *)0), wa, (void*) (long) i);
   pthread_create(&idr[i], ((void *)0), ra, (void*) (long) i);
 }

 pthread_exit (0);
 for (int i = 0; i < 8; i++)
 {
   pthread_join(idw[i],((void *)0));
   pthread_join(idr[i],((void *)0));
 }
}
